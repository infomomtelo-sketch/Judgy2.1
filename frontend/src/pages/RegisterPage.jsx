...
import { Loader2, Mail, Lock, User, AlertCircle, Check, Sun, Moon } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  const benefits = [
    ...
    'Brutally honest advice on demand',
    '1 token per message — simple pricing'
  ];
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-muted-foreground text-sm uppercase tracking-wider mt-1">Create Account</p>
        </div>

        <div className="bg-card border border-border p-8 rounded-lg shadow-elegant">
          <h2 className="font-display text-xl font-bold text-foreground text-center mb-2">Join The Judgment</h2>
          <p className="text-muted-foreground text-sm text-center mb-4">
            Get 50 free tokens to start
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div className="flex items-center gap-2 p-3 bg-destructive/10 border border-destructive/30 text-destructive text-sm rounded-md" data-testid="register-error">
